...
const $undoHideVacancyButtons = document.querySelectorAll('.js-undo-hide-vacancy')
...
const $hideAdditionalBlockButtons = document.querySelectorAll('.js-hide-block-button')
...
const $hideAllVacancyCompanyButton = document.querySelectorAll('.js-hide-all-vacancy-button')
...
const $undoHideCompanyVacanciesButton = document.querySelectorAll('.js-undo-hide-company-vacancies')
